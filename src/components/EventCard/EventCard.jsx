...
const EventCard = ({ title, description, link }) => (
  <div className=" hover:shadow-[0_20px_50px_rgba(255,191,0,0.15)]   w-full h-auto bg-primaryDark rounded-3xl shadow-md overflow-hidden mt-8 px-6 sm:px-8 lg:px-10 py-6 sm:py-8 flex flex-col items-center gap-6 sm:gap-8 transition-transform transform hover:scale-105 duration-300 ease-linear group relative">

    ...
    >
      <div className="flex flex-col md:flex-row items-start gap-4 sm:gap-6 md:gap-8  ">
        ...
        <div className="w-full md:w-1/2 ">
          ...
          <h6 className="text-amber-600 text-sm sm:text-base md:text-lg font-normal tracking-widest">
            comes from the Sanskrit word
          </h6>
          <h3 className="flex items-center gap-2 text-amber-500 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-medium my-2">
            <blockquote className="tracking-widest">“Taruna”</blockquote>
            <span className="text-amber-500 font-semibold">(तरुण)</span>
          </h3>
          ...
          <p className="text-amber-600 text-sm sm:text-base md:text-lg leading-snug mt-4 tracking-wide">
        ...
        <div className="w-full md:w-1/2 mt-4 md:mt-0">
          ...
          <h6 className="text-amber-600 text-sm sm:text-base md:text-lg font-normal tracking-wider">
            The tagline reflects
          </h6>
          <h3 className="text-amber-500 text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium tracking-widest mb-2 lowercase">
            The powerful union of raw passion
          </h3>
          <p className="text-amber-600 text-sm sm:text-base md:text-lg leading-snug mb-2">
          ...
          <p className="text-amber-600 text-base sm:text-lg md:text-xl leading-relaxed font-semibold tracking-widest">
